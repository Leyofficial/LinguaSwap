         ...
         <div className='registerComponent'>
            ...
            <form onSubmit={submitPostData} className="formRegister">
               ...
               <div className="formContainer">
                  ...
                  <div className="blockInput">
                     ...
                     <input onChange={e => handlerChange(e)} value={userValue.email} onBlur={e => blurHandler(e)}
                            type="email" name='email' className="inputRegister"/>
                  ...
                  <div className="blockInput">
                     ...
                     <input onChange={e => handlerChange(e)} value={userValue.password}
                            onBlur={e => blurHandler(e)} type={showPassword ? "text" : "password"}
                            name='password' className="inputRegister"/>
                  ...
                  <div className="blockInput">
                     ...
                     <button className='eyePasswordRegisterConfirm' type="button"
                             onClick={togglePasswordVisibility}>
                        {!showPassword ? <FaEyeSlash/> : <FaEye/>}
                     </button>
                     <input onChange={e => handlerChange(e)} value={userValue.confirmPassword}
                            onBlur={e => blurHandler(e)} type={showPassword ? "text" : "password"}
                            name='confirmPassword' className="inputRegister"/>
                     {(passwordDirty && passwordError) && <div className='passwordError'>{passwordError}</div>}
            ...
            <div className="warningsBlock">
               ...
               <p className="warningInfo">
                  ...
                  Нажимая <NavLink className='warningsLogin'>«Зарегистрироваться»</NavLink> или <NavLink
                  className='warningsLogin'>«Продолжить»</NavLink>, вы принимаете <br/>
