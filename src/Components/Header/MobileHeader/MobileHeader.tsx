...
const MobileHeader = ({navItems}: INavItems) => {
    ...
    return (
        <header className={style.container}>
            <div>
                <div className={ `${style.block}  ${active ? style.active : ""}`}>
                    ...
                    <div className={style.logo}>
                        <h2 className={style.text}>
                            <b>Lin<span style={{color: "dodgerblue", cursor: 'pointer'}}>gua</span></b>
                        </h2>
                        ...
                        <ul className={style.items}>
                            <div className={style.btnWrapper}>
                                <div className={style.navList}>
                                    <List items={navItems}
                                          rerender={(item: INavWrapper, index: number) => <HeaderItem index={index}
                                                                                                      text={item.text}
                                                                                                      link={item.link}/>}/>
                                </div>
                            </div>
