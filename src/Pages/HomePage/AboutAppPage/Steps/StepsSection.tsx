...
const StepsSection = (props:{userType:string | undefined}) => {
   ...
   const forStudent = [{
      title: "Register as a Student using registration form", icon: <PiNumberOneBold/>, image: formImage,isOpen:true},
   ...
   const forTeacher = [{
      title: "Register as a Teacher using registration form and chose your native language", icon: <PiNumberOneBold/>, image: formImage,isOpen:true},
